...
var (
	...
	ErrInvalidDataForParcelIdentity = errors.New("invalid data for parsing IdeCli")
	...
	ErrPeerNameNotFound             = errors.New("peer is not found")
	...
	ErrIdentityNameMissing        = errors.New("IdeCli must have  name")
)
